...
You can read main article from http://www.kenanhancer.com/uni-a-simple-data-access-tool-for-dot-net/
...
object sakilaCallBack = null;
var result = sakila.dyno.Query(CallBack: (Action<object>)(f => sakilaCallBack = f), SP: "film_in_stock", Args: new object[] { 1, 1 });
```
